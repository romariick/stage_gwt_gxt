...
public class PasseportEnvoyeAnosy extends Window {
	...
	public PasseportEnvoyeAnosy() {
		setWidth(692);
		setHeight(365);
		setModal(true);
		
		setHeading("Accueil > Passeport envoy\u00E9 \u00E0 Anosy");
		...
		btnAjouter.addSelectionListener(new SelectionListener<ButtonEvent>() {
			public void componentSelected(ButtonEvent ce) {
					...
					{		
						monServ.ajoutPassportEnvoyeAnosy(numDossier, dates+"", asyncCallbackAjoutPassportEnvoyeAnosy);
