...
public class PasseportArriveeAnosy extends Window {
	...
	public PasseportArriveeAnosy() {
		setWidth(692);
		setHeight(365);
		setModal(true);
		setHeading("Accueil > Passeport arriv\u00E9e \u00E0 Anosy");
		...
		final AsyncCallback<String> asyncCallbackAjoutPassportArriveAnosy = new AsyncCallback<String>() 
		{
			...
			public void onFailure(Throwable caught) {
				...
				MessageBox.info("Erreur", "Impossible d'ajouter l'information", null);
			}
		...
		btnAjouter.addSelectionListener(new SelectionListener<ButtonEvent>() {
			public void componentSelected(ButtonEvent ce) {
					...
					{	
						monServ.ajoutPassportArriveAnosy(numDossier, dates+"", asyncCallbackAjoutPassportArriveAnosy);
